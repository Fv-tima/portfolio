  ...
  return (
    <div className="mt-4 grid grid-cols-1 gap-4 w-full ">
      {app.map((project, index) => (
        <div
          className={`md:w-[650px] w-[330px] rounded-sm shadow-md mx-auto text-white project h-[260px] flex flex-col space-y-4 bg-darkCard p-6 pr-8 transition-all duration-300 
            ${index % 2 === 0 ? 'mt-6' : ''} 
        ...
        >
          ...
          <div className="flex space-x-6 items-end h-full pb-8">
            <Link href={project.github} className="flex text-subtleText items-center space-x-2">
